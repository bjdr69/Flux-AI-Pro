...
const CONFIG = {
  ...
  PROVIDERS: {
    pollinations: {
      ...
      enabled: true,
      default: true,
      description: "完全免费的 AI 图像生成服务 - 支持 Flux & SD3 系列 + 自动高清",
      features: {
        nsfw: true,
        private_mode: true,
        custom_size: true,
      ...
      models: [
        { id: "flux", name: "Flux", confirmed: true, category: "flux", description: "均衡速度与质量" },
        { id: "flux-realism", name: "Flux Realism", confirmed: true, category: "flux", description: "超写实风格" },
        { id: "flux-anime", name: "Flux Anime", confirmed: true, category: "flux", description: "日系动漫风格" },
        { id: "flux-3d", name: "Flux 3D", confirmed: true, category: "flux", description: "3D 渲染风格" },
        { id: "flux-pro", name: "Flux Pro", confirmed: true, category: "flux", description: "专业版最高质量" },
        { id: "any-dark", name: "Any Dark", confirmed: true, category: "flux", description: "暗黑风格" },
        { id: "turbo", name: "Turbo", confirmed: true, category: "flux", description: "极速生成" },
        ...
        { id: "flux-kontext", name: "Flux Kontext 🎨", confirmed: false, fallback: ["flux-pro", "flux-realism"], experimental: true, category: "flux-advanced", description: "图像编辑标准版" },
        { id: "flux-kontext-pro", name: "Flux Kontext Pro 💎", confirmed: false, fallback: ["flux-kontext", "flux-pro", "flux-realism"], experimental: true, category: "flux-advanced", description: "图像编辑专业版" },
        { id: "sd3", name: "Stable Diffusion 3 ⚡", confirmed: false, fallback: ["flux-realism", "flux"], experimental: true, category: "stable-diffusion", description: "SD3 标准版" },
        ...
        { id: "sdxl", name: "SDXL 📐", confirmed: false, fallback: ["flux-realism", "flux"], experimental: true, category: "stable-diffusion", description: "经典 SDXL" },
        { id: "sdxl-lightning", name: "SDXL Lightning ⚡", confirmed: false, fallback: ["turbo", "flux"], experimental: true, category: "stable-diffusion", description: "SDXL 极速版" }
      ],
      rate_limit: null,
  ...
  STYLE_PRESETS: {
    none: { name: "无 (使用原始提示词)", prompt: "", negative: "" },
    "japanese-manga": { name: "日本漫画 🇯🇵", prompt: "Japanese manga style, manga art, black and white manga, detailed linework, screentone, manga panel", negative: "photograph, realistic, 3d render, western comic" },
    "anime": { name: "动漫风格 ✨", prompt: "anime style, anime art, vibrant colors, anime character, detailed anime", negative: "realistic, photograph, 3d, ugly" },
    "vector": { name: "矢量图 📐", prompt: "vector art, flat design, clean lines, minimalist, geometric shapes, vector illustration", negative: "photograph, realistic, textured, noisy" },
    "oil-painting": { name: "油画 🎨", prompt: "oil painting, classical oil painting style, visible brushstrokes, rich colors, artistic", negative: "photograph, digital art, anime" },
    "watercolor": { name: "水彩画 💧", prompt: "watercolor painting, soft colors, watercolor texture, artistic, hand-painted", negative: "photograph, digital, sharp edges" },
    "pixel-art": { name: "像素艺术 👾", prompt: "pixel art, 8-bit style, retro pixel graphics, pixelated", negative: "high resolution, smooth, realistic" },
    "cyberpunk": { name: "赛博朋克 🌃", prompt: "cyberpunk style, neon lights, futuristic, sci-fi, dystopian, high-tech low-life", negative: "natural, rustic, medieval" },
    "fantasy": { name: "奇幻风格 🐉", prompt: "fantasy art, magical, epic fantasy, detailed fantasy illustration", negative: "modern, realistic, mundane" },
    "photorealistic": { name: "写实照片 📷", prompt: "photorealistic, ultra realistic, 8k uhd, professional photography, detailed, sharp focus", negative: "anime, cartoon, illustration, painting" },
    "studio-ghibli": { name: "吉卜力风格 🌿", prompt: "Studio Ghibli style, Ghibli art, Hayao Miyazaki style, whimsical, detailed background", negative: "dark, gritty, realistic" },
    "comic-book": { name: "美式漫画 💥", prompt: "comic book style, American comic art, bold lines, vibrant colors, superhero comic", negative: "photograph, manga, realistic" },
  ...
  PRESET_SIZES: {
    ...
    "portrait": { width: 768, height: 1344, name: "竖屏 9:16" },
    "landscape": { width: 1344, height: 768, name: "横屏 16:9" },
    "standard-portrait": { width: 768, height: 1024, name: "标准竖屏 3:4" },
    "standard-landscape": { width: 1024, height: 768, name: "标准横屏 4:3" },
    "ultrawide": { width: 1536, height: 640, name: "超宽屏 21:9" },
    "ultrawide-portrait": { width: 640, height: 1536, name: "超竖屏 9:21" },
    "custom": { width: 1024, height: 1024, name: "自定义" }
  },
...
class HDOptimizer {
  static optimize(prompt, negativePrompt, model, width, height, autoHD = true) {
    ...
    if (strategy.prompt_level && hdConfig.HD_PROMPTS[strategy.prompt_level]) {
      ...
      optimizations.push(`提示词增强: ${strategy.prompt_level}`);
    }
    ...
    if (strategy.negative) {
      ...
      optimizations.push(`负面提示词: 已添加高清过滤`);
    }
...
class ParameterOptimizer {
  ...
  static calculateOptimalSteps(model, width, height, style) {
    ...
    const reasoning = [];
    reasoning.push(`模型 ${model} 基础: ${baseSteps}步`);
...
<body>
    <div class="container">
        ...
        <div class="subtitle">完整平台 - Flux & SD3 系列 + 智能优化 + 自动高清</div>
        
        <div class="tabs">
            <button class="tab active" onclick="switchTab(event, 'generate')">🎨 生成</button>
            <button class="tab" onclick="switchTab(event, 'history')">📜 历史 (<span id="historyCount">0</span>)</button>
        </div>
        ...
        <div id="generate-tab" class="tab-content active">
            <div class="info-card">
                <h4>🚀 v8.5.0 新功能</h4>
                <p>
                    <strong>✨ 自动高清:</strong> 智能添加高清质量提示词 + 自动尺寸优化<br>
                    <strong>🎯 智能优化:</strong> 根据模型和尺寸自动调整步数<br>
                    <strong>🎨 完整功能:</strong> 17个模型 | 12种风格 | NSFW支持 | 完全免费
                </p>
            </div>
            ...
            <div class="grid">
                <div class="box">
                    ...
                    <label>模型:</label>
                    <select id="model">
                        <optgroup label="✅ Flux 标准">
                            ${fluxModels}
                        </optgroup>
                        <optgroup label="🧪 Flux 高级">
                            ${fluxAdvanced}
                        </optgroup>
                    ...
                    <label>负面提示词:</label>
                    <textarea id="negativePrompt" rows="2" placeholder="不想要的内容..."></textarea>
                ...
                <div class="box">
                    ...
                    <div class="checkbox-group">
                        ...
                        <label for="autoHD">🎨 自动高清 (推荐)</label>
                    </div>
                    <div class="help-text" id="hdHelp" style="color:#10b981">✅ 自动添加高清提示词 + 尺寸优化</div>
                    
                    <div class="checkbox-group">
                        <input type="checkbox" id="autoOptimize" checked onchange="toggleAutoOptimize()">
                        <label for="autoOptimize">🎯 智能优化 (推荐)</label>
                    </div>
                    <div class="help-text" id="optimizeHelp" style="color:#10b981">✅ 自动选择最佳参数</div>
                    
                    <div id="manualParams" style="opacity: 0.5; pointer-events: none;">
                        <label>步数: <span class="range-value" id="stepsValue">20</span></label>
                        <input type="range" id="steps" min="1" max="50" value="20" oninput="document.getElementById('stepsValue').innerText=this.value">
                        
                        <label>引导: <span class="range-value" id="guidanceValue">7.5</span></label>
            ...
            <div class="box">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <button onclick="exportHistory()" style="width: auto; padding: 10px 20px; margin: 0; font-size: 14px;">📥 导出</button>
    ...
    <script>
        ...
        function toggleAutoHD() {
            ...
            if (checked) {
                help.innerText = '✅ 自动添加高清提示词 + 尺寸优化';
                help.style.color = '#10b981';
            } else {
                help.innerText = '⚠️ 已关闭 - 使用原始参数';
        ...
        function loadHistory() {
            ...
            if (history.length === 0) {
                container.innerHTML = '<div class="empty-state"><p style="font-size:18px;">📭</p><p>还没有记录</p></div>';
                return;
            }
        ...
        function renderGeneratingUI(config) {
            ...
            return \`
                <div class="generating-container">
                    ...
                    <div class="generating-title">正在生成图片...</div>
                    <div class="generating-subtitle">AI 正在创作,请稍候</div>
                    ...
                    <div class="progress-container">
                        ...
                        <div class="progress-text">
                            ...
                            <span id="progressTime">预计 <span id="estimatedTime">--</span> 秒</span>
                        </div>
                    </div>
                    ...
                    <div class="generating-info">
                        ...
                        <div class="info-card-small">
                            <div class="info-card-label">数量</div>
                            <div class="info-card-value">\${numOutputs} 张</div>
                        </div>
                        <div class="info-card-small">
                            <div class="info-card-label">步数</div>
        ...
        async function generate() {
            ...
            if (!prompt) {
                resultDiv.innerHTML = '<div class="error">⚠️ 请输入提示词</div>';
                return;
            }
            
            if (nsfw && !confirm('确认您已年满18岁?')) {
                return;
            }
            ...
            setTimeout(() => addStatusMessage('📡 连接服务器...'), 500);
            setTimeout(() => addStatusMessage('🔐 验证参数...', 'success'), 1000);
            setTimeout(() => addStatusMessage('🚀 开始生成...', 'success'), 1500);
            ...
            try {
                ...
                setTimeout(() => {
                    ...
                    const optimizedNote = data.data[0].auto_optimized ? 
                        \`<p style="color: #10b981; font-size: 12px; margin-top: 4px;">🎯 步数: \${data.data[0].steps} (智能优化)</p>\` : '';
                    
                    const hdNote = data.data[0].hd_optimized ? 
                        \`<p style="color: #a78bfa; font-size: 12px; margin-top: 4px;">🎨 高清优化: \${data.data[0].width}x\${data.data[0].height} | 质量增强</p>\` : '';
                    ...
                    resultDiv.innerHTML = \`
                        <div class="success" style="animation: slideIn 0.5s ease-out;">
                            ...
                            <p style="margin-top: 12px; font-size: 14px;">
                                ...
                                <strong>耗时:</strong> \${elapsed}秒 | 
                                <strong>费用:</strong> <span style="color:#10b981">免费</span>
                            </p>
                            \${optimizedNote}
                            \${hdNote}
                        </div>
                ...
                resultDiv.innerHTML = \`
                    <div class="error" style="animation: slideIn 0.5s ease-out;">
                        <strong style="font-size: 18px;">❌ 失败</strong>
                        <p style="margin-top: 12px;">\${error.message}</p>
                        <button onclick="generate()" style="margin-top: 16px; width: auto; padding: 10px 24px;">🔄 重试</button>
                    </div>
                \`;
            }
        }
